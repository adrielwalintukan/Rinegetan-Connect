...
- [x] **Step 1: Write the failing mutation contract test suite**
...
- [x] **Step 3: Implement content mutation server service and API handlers**
...
- [x] **Step 1: Create reusable status badge and filter components**
...
- [x] **Step 2: Create dialogs for content creation, editing, and Admin permanent deletion**
...
- [x] **Step 3: Create table listing, audit log viewer, and main dashboard component**
...
- [x] **Step 4: Update StaffHomePage in `frontend/src/app/staff/(protected)/page.tsx`**
...
- [x] **Step 4: Push branch to origin and create Pull Request**
