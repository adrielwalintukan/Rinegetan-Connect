...
Dokumen [Phase 2 Sprint Plan](PHASE-2-SPRINT-PLAN.md) adalah rincian eksekusi aktif untuk S2.0–S2.5. Setiap sprint menghasilkan issue kecil yang dapat ditinjau melalui pull request menuju `development`.
