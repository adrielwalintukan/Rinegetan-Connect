export const AdventistSymbol = ({ className = "h-10 w-10", title = "Lambang Gereja Masehi Advent Hari Ketujuh" }) => (
    <svg
        viewBox="0 0 169.8 170.10001"
        className={className}
        role="img"
        aria-label={title}
        data-testid="adventist-symbol"
    >
        <g transform="translate(-20.5,-20.6)">
            <path
                fill="currentColor"
